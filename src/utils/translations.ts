...
export const translations: Record<string, Translations> = {
  en: {
    ...
    userId: "User ID",
    userIdOrEmailId: "User ID or Email ID",
    enterUserIdOrEmailId: "Enter User ID or Email ID",
  ...
  hi: {
    ...
    userId: "यूजर आईडी",
    userIdOrEmailId: "यूजर आईडी या ईमेल आईडी",
    enterUserIdOrEmailId: "यूजर आईडी या ईमेल आईडी लिखें",
    ...
    referralDiscountNote3: "लिखें और किसी भी पेड सब्सक्रिप्शन प्लान पर तुरंत",
    referralDiscountNote4: "",
